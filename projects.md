...
Abaixo, mostro um exemplo de uma linha de luz montada no software OASYS com o auxilio do pacote SHADOW, para simulação das linhas de luz
![Linha simulada Caterete]({{ "/assets/images/workspacecaterete.jpg" | relative_url }})
...
Outra linha, mais complexa do que a primeira, tem os seus elementos ópticos mostrados no simulador abaixo:
![Linha simulada Carnauba]({{ "/assets/images/carnaubaworkspace1(1).jpg" | relative_url }})

Abaixo um resultado do feixe de outra linha de luz demonstrado em Python:
![Feixe Taruma]({{ "/assets/images/tarumaniflux.jpg" | relative_url }})
...
![LIBS Pb]({{ "/assets/images/PbI.jpg" | relative_url }})

Complemento com exemplo de Zn II (zinco iônico) 
![LIBS Zn]({{ "/assets/images/znII.jpg" | relative_url }})
